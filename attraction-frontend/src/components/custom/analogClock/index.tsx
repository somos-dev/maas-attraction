...
export default function AnalogClock() {
  ...
  const hoursDegrees = state.date.getHours() * 30 + state.date.getMinutes() / 2;
  const minutesDegrees = state.date.getMinutes() * 6 + state.date.getSeconds() / 10;
  const secondsDegrees = state.date.getSeconds() * 6;
    ...
    >
      <div>
          ...
          <div id="clock" className="clock-content">
            ...
            <div
              ...
              className={
                ...
                (state.date.getHours() === 0 ? '' : 'transition-effect')
              }
              style={divStyleHours}
            />
            <div
              ...
              className={
                ...
                (state.date.getMinutes() === 0 ? '' : 'transition-effect')
              }
            ...
            <div
              ...
              className={
                ...
                (state.date.getSeconds() === 0 ? '' : 'transition-effect')
              }
        ...
        <div className="dateContainer">
          <div className="date"> {moment(state.date).format('ddd DD MMMM')}</div>
        </div>
      </div>
    </Card>
  );
